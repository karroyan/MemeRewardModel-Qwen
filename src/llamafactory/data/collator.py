...
@dataclass
class MultiModalDataCollatorForClassification(DataCollatorForTokenClassification):
    r"""Data collator that supports VLMs.
    ...
    #     # save model to self.model, then delete model in kwargs
...
@dataclass
class ClassificationDataCollatorWithPadding(MultiModalDataCollatorForClassification):
    r"""Data collator for pairwise data."""
